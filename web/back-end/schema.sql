...
(
    ...
    update_time datetime(3)      NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3),
    delete_time datetime(3)               DEFAULT NULL,
    `status` int(10) NOT NULL COMMENT '0联系管理员，1可以登录',
    email_validation tinyint(1) DEFAULT NULL,
    PRIMARY KEY (id),
...
-- ----------------------------
BEGIN;
INSERT INTO lin_user(id, username, nickname, email, `status`, email_validation)
VALUES (1, 'administrator@163.com', 'administrator', 'administrator', 1, 1);

INSERT INTO lin_user_identity (id, user_id, identity_type, identifier, credential)

VALUES (1, 1, 'USERNAME_PASSWORD', 'administrator@163.com',
        'sha1$f5f075d4$1$c74e6120b54562a2a0a275bf14d0d8f8050d85ec');
